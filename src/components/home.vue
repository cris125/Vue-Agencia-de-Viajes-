    ...
    <body>
        ...
        <div class="buscador">
            <form>
                ...
                <br><input type="text" id="fname" name="fname" placeholder="¿Donde quieres Viajar?" ><br>    
            </form>
        ...
        <div class="ofertas">
            ...
            <a href="" class="h9">Ciudad de Mexico </a>
            <a href="" class="h10">Miami</a>
...
.ofertas .h7 text{
 ...
 /* ofertassssssssssssss */ 
    ...
    .OfertasExclusivas  form button:hover{
